...
export function AnalyzeBg() {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            connectionsRef.current = connectionsRef.current.filter((connection) => {
                ...
                ctx.strokeStyle = `rgba(${colorRGB}, ${connection.opacity * (1 - connection.progress * 0.5)})`
                ctx.lineWidth = 1
                ctx.beginPath()
                ...
                const dotSize = 2
                ctx.fillStyle = `rgba(${colorRGB}, ${connection.opacity * 1.5})`
                ctx.beginPath()
    ...
    return (
        <div className="fixed inset-0 w-full h-full overflow-hidden -z-10">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-200/50 via-pink-200/50 to-indigo-300/50 dark:from-purple-500/30 dark:via-pink-500/40 dark:to-indigo-900/50 blur-3xl scale-125 transition-colors duration-500" />
            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-100/60 via-transparent to-purple-200/50 dark:from-indigo-950/60 dark:via-transparent dark:to-purple-900/40 blur-2xl scale-125 transition-colors duration-500" />
